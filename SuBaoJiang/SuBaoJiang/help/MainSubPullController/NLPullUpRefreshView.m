...
#define REFRESH_PULL_UP_STATUS @"上拉查看详情"
#define REFRESH_RELEASED_STATUS @"快松开我吧"
// 加载中
#define REFRESH_LOADING_STATUS @""
#define REFRESH_NO_MORE @"没有更多了哟"
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        self.refreshLabel.backgroundColor = [UIColor whiteColor];
...
- (void)clearStyle
{
    self.refreshLabel.backgroundColor = COLOR_BACKGROUND ;
    self.refreshLabel.textColor = COLOR_BACKGROUND ;
